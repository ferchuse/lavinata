<?php
	...
	$select = "<select required class='form-control' id='id_compras' name='id_compras'>";
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group ">
						<label for="">Orden de Compra: <a target="_blank" href="../compras/compras_lista.php">Ver Compras</a></label>
						<?= $select?>
					</div>
					<div class="form-group " hidden>
